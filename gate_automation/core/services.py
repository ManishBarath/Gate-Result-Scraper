...
class GateResultService:
    ...
    def __init__(self, credential_loader: CredentialLoader, portal_client: PortalClient, result_sinks: Iterable[ResultSink]) -> None:
        ...
        try:
            for credential in credentials:
                try:
                    ...
                    result = CandidateResult(enrollment_id=credential.enrollment_id, status='failed', message=f'Unhandled error: {error}')
